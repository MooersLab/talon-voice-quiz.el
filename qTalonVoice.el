...
(defun voiceControl/q602 (INPUT)
  "Interactive quiz question about ."
  (interactive "sOn macOS, enter ___ ____ to toggle on or off the Voice Control. ")
  (message
    (pcase INPUT
      ("" "Correct! Explanation:   Source: ")
      ("1" "Correct! Explanation:   Source: ")
...
(defun voiceInPlus/q603 (INPUT)
  "Interactive quiz question about option L."
  (interactive "sOn macOS, enter ___ __ to toggle Voice In on or off in the Chrome browser. ")
  (message
    (pcase INPUT
      ("option L" "Correct! Explanation:   Source: ")
      ("1" "Correct! Explanation:   Source: ")
      (_ "Answer: option L. Look up answer in Emacs with 1"))))
